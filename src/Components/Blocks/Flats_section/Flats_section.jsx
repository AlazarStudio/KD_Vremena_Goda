        ...
        <>
            ...
            <div ref={flatsTextInfoRef} className={classes.flatsTextInfo}>
                ...
                <div className={`${classes.flatsTextInfo_descText} ${flatsTextInfoMetrics.progress >= 0.25 ? classes.show : ""}`}>
                    Жилой комплекс представляет собой однокорпусное здание высотой до 12 этажей.

                    <br />
                    <br />
                    Фасады оформлены с использованием благородных материалов, которые подчеркивают элегантность и стиль проекта. Каждая деталь продумана так, чтобы дом гармонично вписывался в городское пространство и сохранял свою привлекательность долгие годы.
                </div>
                ...
                <div className={classes.flatsTextInfo_underText}>
                    <div className={`${classes.flatsTextInfo_underText_right} ${flatsTextInfoMetrics.progress >= 0.35 ? classes.show : ""}`}>
                        В основе проекта — внимание к качеству и стремление создать пространство, где архитектура становится частью образа жизни.
                    </div>
                </div>
            </div>
                ...
                <div className={classes.flatsTextInfo_underText}>
                    <div className={classes.flatsTextInfo_underText_block}>
                        <div className={`${classes.flatsTextInfo_underText_block_desc} ${flatsTextInfoNewMetrics.progress >= 0.25 ? classes.show : ""}`}>
                            Мы стремимся к экологичности и комфорту. Поэтому в интерьерах общественных помещений клубного дома мы используем натуральные материалы. 
                        </div>
                        <div className={`${classes.flatsTextInfo_underText_block_desc} ${flatsTextInfoNewMetrics.progress >= 0.25 ? classes.show : ""}`}>
